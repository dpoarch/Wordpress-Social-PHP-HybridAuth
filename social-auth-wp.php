<?php
/*
Plugin Name: Social HybridAuth Wordpress Login
Plugin URI: https://github.com/dpoarch/Wordpress-Social-PHP-HybridAuth
Description: Social HybridAuth Wordpress Login is a Wordpress plugin derived from popular PHP based HybridAuth library. Inspired from other Wordpress social login plugins. Allows you to gain access via Facebook, Google, Instagram etc.
Version: 2.0.0
Author: David Poarch
